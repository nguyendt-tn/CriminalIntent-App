...
import android.example.criminalintent.database.CrimeBaseHelper;
import android.example.criminalintent.database.CrimeCursorWrapper;
import android.example.criminalintent.database.CrimeDbSchema;
